package staticvariable.literalpool;
...
public class DemoString {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(str1 == str2); // true , literal pool // == : ask is it in same object

    String str3 = "hello!";
    System.out.println(str1.equals(str3)); // false // .equals check value
    System.out.println(str1 == str3); // false, different value // == : check object
    ...
    System.out.println(str1 == str5); // true, loop up literal
    ...
    // Java Compiler would NOT look at the calue assigned to object reference during the
    // String str6 = null; // 因為變數str6為空 didn't point to any object
    // if (str6.equals("hello")) { // error
