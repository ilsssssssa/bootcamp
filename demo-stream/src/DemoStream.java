...
public class DemoStream {
  public static void main(String[] args) throws Exception {
    ...
    // Retrieve取回 all addresses from a list of customers
    ...
    List<List<Customer.Address>> listOfAddresses = customers.stream() //
    ...
    // Don't know if Variable = (null) so put (null) in it to see if it is empty
    ...
    // Stream.of(cat); // error 
    // Unresolved compilation problem: cat cannot be resolved to a variable
