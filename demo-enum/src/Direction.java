public enum Direction {
  ...
  NORTH(1), EAST(2), WEST(-2), SOUTH(-1),; //定義了四個方向常數 + (每個方向常數的值)

  private int value; //用於存儲每個方向常數的值( )
  ...
  public boolean isOppodite(Direction direction) {
  ...
  public static void main(String[] args) {
    ...
    String result2 = Direction.WEST.opposite().toString(); // Enum.class to String() result2 = "EAST"
