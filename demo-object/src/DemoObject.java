public class DemoObject { // extends Object implicitly隱含地
  ...
  public static void main(String[] args) {
    ...
    if (do3.getClass() == DemoObject.class) { // kind of *instanceof*
    ...
    System.out.println(c1.equals(c4)); // false, different name & age
